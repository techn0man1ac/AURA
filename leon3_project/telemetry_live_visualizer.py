    ...
    try:
        while True:
            ...
            while len(data_buffer) >= packet_size:
                # ФІКС: Витягуємо чисте ціле число за допомогою індексу [0]
                ...
                if sync_byte == 0x5A:  
                    ...
                    ax.set_title(f"AURA Compressed Feed ({rows}x{cols} Blocks)")
                    plt.ion()
                    ...
                    if row_idx < rows and col_idx < cols:
                        ...
                        # Жива асинхронна промальовка кожні 100 блоків
